...
public class CitizenApi {
    ...
    public static @NotNull Response citizens(@NotNull Request request) throws Exceptions.HttpException {
        return switch(request.requestLine.method) {
            case GET -> getCitizens(request);
            default -> throw new Exceptions.MethodNotAllowedException();
        };
    }

    @Contract("_ -> new")
    public static @NotNull Response getCitizens(@NotNull Request request) throws Exceptions.HttpException {
